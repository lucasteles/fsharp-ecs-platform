...
module Collider =
    let fromRect rect =  {ColliderBounds = rect; IsTrigger=false} |> ColliderGroup.single
    let triggerRect rect =  {ColliderBounds = rect; IsTrigger=true} |> ColliderGroup.single
